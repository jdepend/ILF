...
public class JspHandle extends PackageHandle{

	@Override
	public void modifyPackage(ProjectModuleBO bo, String oldPath) throws BOException {
		String rootPath = ProjectPathUtil.getProjectPath()+ ImpConfigConstant.DEFAULT_JSPPATH;
		String path = rootPath + bo.getJspPackage();
	...
	protected String getPath(ProjectModuleBO bo) {
		return ProjectPathUtil.getProjectPath()+ ImpConfigConstant.DEFAULT_JSPPATH + bo.getJspPackage();
	}
