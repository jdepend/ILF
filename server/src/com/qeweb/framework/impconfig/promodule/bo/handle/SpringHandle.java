...
public class SpringHandle extends PackageHandle{

	@Override
	public void modifyPackage(ProjectModuleBO bo, String oldPath)
			throws BOException {
		String rootPath = ProjectPathUtil.getProjectPath()+ ImpConfigConstant.DEFAULT_SPRINGPATH;
		String path = rootPath + bo.getSpringPackage();
	...
	protected String getPath(ProjectModuleBO bo) {
		return ProjectPathUtil.getProjectPath()+ ImpConfigConstant.DEFAULT_SPRINGPATH + bo.getSpringPackage();
	}
