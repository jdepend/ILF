...
public class VarHandle extends PackageHandle{

	@Override
	public void modifyPackage(ProjectModuleBO bo, String oldPath)
			throws BOException {
		String rootPath = ProjectPathUtil.getProjectPath()+ ImpConfigConstant.DEFAULT_VARPATH;
		String path = rootPath + bo.getVarPackage();
	...
	protected String getPath(ProjectModuleBO bo) {
		return ProjectPathUtil.getProjectPath()+ ImpConfigConstant.DEFAULT_VARPATH + bo.getVarPackage();
	}
