...
Ext.ux.form.MultiSelect = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
		...
		if(this.itemSelectorId != undefined && this.itemSelectorId != null){
			itemSelectorId = this.itemSelectorId;
		}
...
Ext.extend(Ext.ux.form.MultiSelect.DragZone, Ext.dd.DragZone, {
    ...
    getDragData: function(e){
    	if(Ext.getCmp(itemSelectorId).viewType != "view"){
