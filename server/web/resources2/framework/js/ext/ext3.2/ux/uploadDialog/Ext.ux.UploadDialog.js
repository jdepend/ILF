...
Ext.extend(Ext.ux.UploadDialog.Dialog, Ext.Window, {
	...
	fillToolbar : function() {
		...
		if (this.isView == false) {
			...
			tb.x_buttons.indicator = tb.addItem(new Ext.Toolbar.Item(Ext.DomHelper.append(tb
									.getEl(), {
		...
		tb.x_buttons.close = tb.addButton({
					...
					scope : this,
					iconCls : 'ext-ux-uploaddialog-closebtn'
				});
	},
	...
	updateProgressBar : function() {
		if (this.is_uploading) {
			...
			this.progress_bar
					.updateProgress(0, this.i18n.note_upload_success)
		}
	},
	...
	removeFiles : function(file_records) {
		var p = this;
		var delIds = "";
		Ext.MessageBox.confirm(this.i18n.confirm_tip, this.i18n.confirm_msg, function(btn) {
					if (btn == 'yes') {
...
//											showMSG.showOK('删除附件成功！');
//										},
//										failure : function(result, request) {
//											showMSG.showErr('删除附件失败');
//										},
//										params : {
//											fileIds : delIds
//										}
