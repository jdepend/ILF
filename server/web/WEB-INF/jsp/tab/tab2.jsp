...
<body>
<div class="container" style="height: 100%; padding: 15% 4%">
    <!-- 代码开始 -->
    <svg version="1.1" id="clock" x="0px"
         y="0px"
...
<circle id="face" fill="#F4F3ED" cx="243.869" cy="250.796" r="130.5"/>
	...
	C379.527,325.719,318.791,386.455,243.869,386.455z"/>
        ...
        <g id="markings">
            ...
            <text transform="matrix(1 0 0 1 282 174.4307)" fill="#303030" font-family="'Futura-Medium'" font-size="26">
                1
            </text>
...
<script src='<%=basePath%>/resources/js/snap.svg-min.js'></script>
<script src="<%=basePath%>/resources/js/clock.js"></script>
</html>
