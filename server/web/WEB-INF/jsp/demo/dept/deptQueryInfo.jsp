        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <div id="query_start_group">
                    <input type="text" name="query_start" id="query_start" value="2016-01-01" readonly/>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <div id="query_end_group">
                    <input type="text" name="query_end" id="query_end" value="2016-01-31" readonly/>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        $("#submit").click(function(){
            ...
            request("<%=basePath%>/dept/query/page/list", data);
        });
