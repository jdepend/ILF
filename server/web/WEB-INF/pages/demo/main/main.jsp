...
<html>
	<frameset rows="112px,*,3%" id="frameset">
		<frame id="iframeTop" name="iframeTop" src="<%=ctx %>/demo/top.action" frameborder="NO" marginheight="0" marginwidth="0"/>
		<frameset cols="18%,*" id="iframeMiddle">
			<frame id="iframeLeft" name="iframeLeft" src="<%=ctx %>/demo/menu.action"  frameborder="NO" marginheight="0" scrolling="no" marginwidth="0"/>
