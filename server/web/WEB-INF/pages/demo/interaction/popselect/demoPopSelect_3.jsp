...
<qeweb:page onLoad="table.sysFresh">
	<qeweb:form id="form" bind="demoPopSelectBO3" layout="3;C2(purchaseNo)" text="弹出选择(翻页记忆)">
		<qeweb:textField bind="purchaseNo" text="订单号(多选)">
			<qeweb:source bindBo="demoPopSelect_PO3" bindBop="purchaseNo:purchaseNo" sm="checkbox" text="订单号(多选)"/>
		</qeweb:textField>
		<qeweb:commandButton name="save" operate="save" text="form.save"/>
		<qeweb:commandButton name="sysReset" operate="sysReset" />
	</qeweb:form>
	
	<qeweb:table id="table" bind="demoPopSelectBO3" text="弹出框翻页记忆">
		<qeweb:commandButton name="selectBtn" icon="folder" text="选择">
			<qeweb:source bindBo="demoPopSelect_PO3" sm="checkbox" text="弹出选择采购订单(翻页记忆)"
