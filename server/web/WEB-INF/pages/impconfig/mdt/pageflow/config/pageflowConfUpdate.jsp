...
<%--修改页面流配置 --%>
<qeweb:page>
	<qeweb:form id="pageflowConfigForm" bind="pageflowConfBO" layout="2;C2(sourcePage,targetPage,targetVC,remark)" param="required" text="页面流配置">
		<qeweb:select bind="moduleId" text="模块名称"/>
		<qeweb:select bind="fileName" text="页面流文件名称"/>
		<qeweb:select bind="pageflowType" text="类型"/>
		...
		<qeweb:hidden bind="boId_old" />
		<qeweb:hidden bind="bindBop_old" />
		<qeweb:hidden bind="btnName_old" />
		<qeweb:hidden bind="sourcePage_old" />
