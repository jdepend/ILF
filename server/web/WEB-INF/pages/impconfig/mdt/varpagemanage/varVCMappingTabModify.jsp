...
<qeweb:page bind="varPageAllBO">
	...
	<qeweb:table id="varConfTable" bind="varConfBO" text="变量设置" hasBbar="false" param="required" sm="empty"
	...
	<qeweb:table id="sheetBOTable" bind="sheetBO" text="sheet页信息" hasBbar="false" param="required"
