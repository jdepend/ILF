...
<qeweb:page bind="phyAllBO">
	<qeweb:commandButton name="save" operate="insert" text="form.save" icon="save"/>
	<qeweb:commandButton name="viewCreateSql" operate="phyAllBO.viewCreateTableSql" text="查看SQL" icon="view"/>
	<qeweb:commandButton name="goBack" text="form.back"/>
	
	<qeweb:tab id="tableTab">
		<qeweb:sheet id="tableInfo" text="表信息 ">
			<qeweb:form id="phyTableBOForm" bind="phyTableBO" text="" layout="2;C2(remark)">
		...
		<qeweb:sheet id="phyColumnBO" text="列信息 ">
			<qeweb:table id="phyTphyColumnBOTable" bind="phyColumnBO" hasBbar="false" text=""
