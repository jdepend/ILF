...
<form id="loginForm" action="<%=ctx %>/system/login!login.action"  method="post">
	<div align="center"><img align="top" src="<%=ctx %>/framework/images/demo/bosideng.jpg" height="120"></div>
	<ul class="rounded">
	...
	<input type="hidden" name="displayType" value="<%=ConstantAppProp.DISPLAYTYPE_ANDROID%>"/>
</form>
</ul>
</body>
</html>
<div style="display:none">
<jsp:include page="/system/mobileOffLineAC.action"></jsp:include>
</div>